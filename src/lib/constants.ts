...
export const GITHUB_URL = 'https://github.com/prodbyeagle/Vencord';
export const ORIGINAL_GITHUB_AUTHOR = 'https://github.com/Vendicated';
export const VENCORD_GITHUB = 'https://github.com/Vencord';
...
export const PLUGINS_JSON_URL =
	'https://raw.githubusercontent.com/prodbyeagle/dotfiles/refs/heads/main/Vencord/eagleCord/plugins.json';
